...
public class Branches {
	...
	@FindBy(xpath = "//section[2]/div[2]/div/div/table/tbody/tr/td")
	...
	public List<String> getUpdatedBranchDetails () {
		 List<String>  myAlist = new ArrayList<String>();
			...
			for (WebElement j : updatedbranchformelements) {
				myAlist.add(j.getText());
	...
	public Branches enterUpdatedDetails(String bname, String mail, String phn, String mob, String gst,
			String add1, String add2, String  ste, String pin) {
